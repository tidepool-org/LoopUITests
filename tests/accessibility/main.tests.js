...
module.exports = (test) => {
  describe("Status Screen", () => {
    ...
    describe.skip("HUD", () => {
      it("add pump button", async () => {
        await expect(
          statusScreen.HeaderSection.Devices.AddPumpButton
        ).toBeVisible();
      });
      it("add CGM button", async () => {
        await expect(
          statusScreen.HeaderSection.Devices.AddCGMButton
        ).toBeVisible();
      });
      ...
      it("Tap to add blood glucose button", async () => {
        await expect(
          statusScreen.HeaderSection.EnterBloodGlucoseButton
        ).toBeVisible();
      });
      it("No recent blood glucose label", async () => {
        await expect(
          statusScreen.HeaderSection.NoRecentBloodGlucoseLabel
        ).toBeVisible();
      });
    });
  });
  describe.skip("Insulin Delivery Chart", () => {
  ...
  describe.skip("Active Carbohydrates Chart", () => {
    ...
    it("has a Grams Active Carbs Label", async () => {
      await expect(
        activeCarbohydratesChart.GramsActiveCarbsLabel
      ).toBeVisible();
    });
  ...
  describe.skip("Active Insulin Chart", () => {
