module.exports = (test) => {
    ...
    it('has suspend thresold label', async () => {
        await screen.SwipeUpUntil(screen.SuspendThresholdLabel());
    ...
    it('has correction range label', async () => {
        await screen.SwipeUpUntil(screen.CorrectionRangeLabel());
    ...
    it('has pre-meal range label', async () => {
        await screen.SwipeUpUntil(screen.PreMealRangeLabel());
    ...
    it('has workout range label', async () => {
        await screen.SwipeUpUntil(screen.WorkoutRangeLabel());
    ...
    it('has basal rate label', async () => {
        await screen.SwipeUpUntil(screen.BasalRateLabel());
    ...
    it('has delivery limits label', async () => {
        await screen.SwipeUpUntil(screen.DeliveryLimitsLabel());
    ...
    it('has insulin model label', async () => {
        await screen.SwipeUpUntil(screen.InsulinModelLabel());
    ...
    it('has carb ratios label', async () => {
        await screen.SwipeUpUntil(screen.CarbRatiosLabel());
    ...
    it('has insulin sensitivities label', async () => {
        await screen.SwipeUpUntil(screen.InsulinSensitivitiesLabel());
