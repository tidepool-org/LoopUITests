...
const PredictedGlucoseScreen = require("./PredictedGlucoseScreen");
...
class HomeScreen {
  constructor(language, settingsScreenDefaults) {
    this._predictedGlucoseScreen = new PredictedGlucoseScreen(language);
  ...
  get GlucoseLabel() {
    return this._predictedGlucoseScreen.OpenButton;
  }
  get SettingsButton() {
  ...
  async OpenGlucoseChart() {
    ...
    return this._predictedGlucoseScreen;
  }
  get SettingsScreen(){
